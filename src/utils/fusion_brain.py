...
from src.config import FUSION_BRAIN_API_KEY, FUSION_BRAIN_SECRET_KEY
...
def generate_image(name: str) -> str:
    try:
        api = FusionBrain('https://api-key.fusionbrain.ai/', FUSION_BRAIN_API_KEY, FUSION_BRAIN_SECRET_KEY)
